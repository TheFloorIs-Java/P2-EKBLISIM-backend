...
public class PaymentControllerAccTest {
    ...
    public void addInvalidPayment() {
        Payment payment = new Payment("KEN", null, "1111111111111111", "666", "02", "2026");
        String paymentJSON = ObjToJSON.JSONify(payment);
    ...
    public void getPayment() {
        Payment payment = new Payment("DAN", null, "4485295529430250", "666", "02", "2026");
        String paymentJSON = ObjToJSON.JSONify(payment);
        ...
        RequestBuilder getPaymentRequest = MockMvcRequestBuilders.get("/payments/DAN");
