...
public class UserControllerAccTest {
    ...
    @Test
    public void signUp() {
        UserAccount user = new UserAccount("CHAD", null, null, "CHAD");
    ...
    public void signUpWithSpace() {
        UserAccount user = new UserAccount("DO G", null, null, "DOUG");
        String uaJSON = ObjToJSON.JSONify(user);
    ...
    @Test
    public void signIn() {
        UserAccount user = new UserAccount("BILL", null, null, "BILL");
    ...
    public void signInInvalidPassword() {
        UserAccount user = new UserAccount("DANTE", null, null, "DANTE");
        String userJSON = ObjToJSON.JSONify(user);
